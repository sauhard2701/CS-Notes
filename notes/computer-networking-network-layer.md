...
<!-- GFM-TOC -->
* [计算机网络 - 网络层](#computer-networking---network-layer)
    * [概述](#overview)
    * [IP 数据报格式](#ip-datagram-format)
    * [IP 地址编址方式](#ip-addressing)
        * [1. 分类](#1-classful-addressing)
        * [2. 子网划分](#2-subnetting)
        * [3. 无分类](#3-classless-addressing)
    * [地址解析协议 ARP](#address-resolution-protocol-arp)
    * [网际控制报文协议 ICMP](#internet-control-message-protocol-icmp)
        * [1. Ping](#1-ping)
        * [2. Traceroute](#2-traceroute)
    * [虚拟专用网 VPN](#virtual-private-network-vpn)
    * [网络地址转换 NAT](#network-address-translation-nat)
    * [路由器的结构](#router-structure)
    * [路由器分组转发流程](#router-packet-forwarding-process)
    * [路由选择协议](#routing-protocols)
        * [1. 内部网关协议 RIP](#1-interior-gateway-protocol-rip)
        * [2. 内部网关协议 OSPF](#2-interior-gateway-protocol-ospf)
        * [3. 外部网关协议 BGP](#3-exterior-gateway-protocol-bgp)
<!-- GFM-TOC -->
