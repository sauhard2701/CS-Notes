...
* [LeetCode Solutions - Trees](#leetcode-solutions---trees)
    * [Recursion](#recursion)
        * [1. Maximum Depth of Binary Tree](#_1-maximum-depth-of-binary-tree)
        * [2. Balanced Binary Tree](#_2-balanced-binary-tree)
        * [3. Diameter of Binary Tree](#_3-diameter-of-binary-tree)
        * [4. Invert Binary Tree](#_4-invert-binary-tree)
        * [5. Merge Two Binary Trees](#_5-merge-two-binary-trees)
        * [6. Path Sum](#_6-path-sum)
        * [7. Path Sum III](#_7-path-sum-iii)
        * [8. Subtree of Another Tree](#_8-subtree-of-another-tree)
        * [9. Symmetric Tree](#_9-symmetric-tree)
        * [10. Minimum Depth of Binary Tree](#_10-minimum-depth-of-binary-tree)
        * [11. Sum of Left Leaves](#_11-sum-of-left-leaves)
        * [12. Longest Univalue Path](#_12-longest-univalue-path)
        * [13. House Robber III](#_13-house-robber-iii)
        * [14. Second Minimum Node in a Binary Tree](#_14-second-minimum-node-in-a-binary-tree)
    * [Level Order Traversal](#level-order-traversal)
        * [1. Average of Levels in Binary Tree](#_1-average-of-levels-in-binary-tree)
        * [2. Find Bottom Left Tree Value](#_2-find-bottom-left-tree-value)
    * [Preorder, Inorder, and Postorder Traversal](#preorder-inorder-and-postorder-traversal)
        * [1. Binary Tree Preorder Traversal](#_1-binary-tree-preorder-traversal)
        * [2. Binary Tree Postorder Traversal](#_2-binary-tree-postorder-traversal)
        * [3. Binary Tree Inorder Traversal](#_3-binary-tree-inorder-traversal)
    * [BST](#bst)
        * [1. Trim a Binary Search Tree](#_1-trim-a-binary-search-tree)
        * [2. Kth Smallest Element in a BST](#_2-kth-smallest-element-in-a-bst)
        * [3. Convert BST to Greater Tree](#_3-convert-bst-to-greater-tree)
        * [4. Lowest Common Ancestor of a BST](#_4-lowest-common-ancestor-of-a-bst)
        * [5. Lowest Common Ancestor of a Binary Tree](#_5-lowest-common-ancestor-of-a-binary-tree)
        * [6. Convert Sorted Array to Binary Search Tree](#_6-convert-sorted-array-to-binary-search-tree)
        * [7. Convert Sorted List to Binary Search Tree](#_7-convert-sorted-list-to-binary-search-tree)
        * [8. Two Sum IV - Input Is a BST](#_8-two-sum-iv---input-is-a-bst)
        * [9. Minimum Absolute Difference in BST](#_9-minimum-absolute-difference-in-bst)
        * [10. Find Mode in Binary Search Tree](#_10-find-mode-in-binary-search-tree)
    * [Trie](#trie)
        * [1. Implement Trie](#_1-implement-trie)
        * [2. Map Sum Pairs](#_2-map-sum-pairs)
<!-- GFM-TOC -->
