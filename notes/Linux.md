...
* [Linux](#linux)
    * [Preface](#preface)
    * [1. Common Operations and Concepts](#_1-common-operations-and-concepts)
        * [Shortcuts](#shortcuts)
        * [Help](#help)
        * [Shutdown](#shutdown)
        * [PATH](#path)
    ...
    * [3. Partitions](#_3-partitions)
        * [Partition Table](#partition-table)
        * [Boot-Time Checker](#boot-time-checker)
    * [4. File Systems](#_4-file-systems)
    ...
    * [6. Compression and Archiving](#_6-compression-and-archiving)
    ...
    * [8. Pipeline Commands](#_8-pipeline-commands)
    ...
    * [9. Regular Expressions](#_9-regular-expressions)
        * [grep](#grep)
        * [printf](#printf)
        * [awk](#awk)
    * [10. Process Management](#_10-process-management)
