...
* [Clustering](#clustering)
    * [1. Load Balancing](#_1-load-balancing)
        * [Load Balancing Algorithms](#load-balancing-algorithms)
            * [1. Round Robin](#_1-round-robin)
            * [2. Weighted Round Robin](#_2-weighted-round-robin)
            * [3. Least Connections](#_3-least-connections)
            * [4. Weighted Least Connections](#_4-weighted-least-connections)
            * [5. Random](#_5-random)
            * [6. IP Hash](#_6-ip-hash)
        * [Forwarding Implementation](#forwarding-implementation)
            * [1. HTTP Redirect](#_1-http-redirect)
            * [2. DNS Resolution](#_2-dns-resolution)
            * [3. Reverse Proxy Server](#_3-reverse-proxy-server)
            * [4. Network Layer](#_4-network-layer)
            * [5. Link Layer](#_5-link-layer)
    * [2. Session Management in Clusters](#_2-session-management-in-clusters)
