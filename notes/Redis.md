...
* [Redis](#redis)
    ...
    * [四、使用场景](#4-use-cases)
        ...
        * [其它](#miscellaneous)
    * [五、Redis 与 Memcached](#5-redis-and-memcached)
        * [数据类型](#data-types)
        * [数据持久化](#data-persistence)
        * [分布式](#distributed-systems)
        * [内存管理机制](#memory-management)
    * [六、键的过期时间](#6-key-expiration)
    * [七、数据淘汰策略](#7-eviction-policy)
    * [八、持久化](#8-persistence)
        * [RDB 持久化](#rdb-persistence)
        * [AOF 持久化](#aof-persistence)
    * [九、事务](#9-transactions)
    * [十、事件](#10-events)
        * [文件事件](#file-events)
        * [时间事件](#time-events)
        * [事件的调度与执行](#event-scheduling-and-execution)
    * [十一、复制](#11-replication)
        * [连接过程](#connection-process)
        * [主从链](#replication-chain)
    * [十二、Sentinel](#12-sentinel)
    * [十三、分片](#13-sharding)
    * [十四、一个简单的论坛系统分析](#14-simple-forum-system-analysis)
        * [文章信息](#article-information)
        * [点赞功能](#like-feature)
        * [对文章进行排序](#article-sorting)
    * [参考资料](#references)
<!-- GFM-TOC -->
