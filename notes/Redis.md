...
* [Redis](#redis)
    ...
    * [2. Data Types](#_2-data-types)
        * [STRING](#string)
        * [LIST](#list)
        * [SET](#set)
        * [HASH](#hash)
        * [ZSET](#zset)
    * [3. Data Structures](#_3-data-structures)
    ...
    * [5. Redis and Memcached](#_5-redis-and-memcached)
        * [Data Types](#data-types)
        * [Data Persistence](#data-persistence)
        * [Distributed Systems](#distributed-systems)
        * [Memory Management](#memory-management)
    * [6. Key Expiration](#_6-key-expiration)
    * [7. Eviction Policy](#_7-eviction-policy)
    * [8. Persistence](#_8-persistence)
        * [RDB Persistence](#rdb-persistence)
        * [AOF Persistence](#aof-persistence)
    * [9. Transactions](#_9-transactions)
    * [10. Events](#_10-events)
        * [File Events](#file-events)
        * [Time Events](#time-events)
        * [Event Scheduling and Execution](#event-scheduling-and-execution)
    * [11. Replication](#_11-replication)
        * [Connection Process](#connection-process)
        * [Replication Chain](#replication-chain)
    * [12. Sentinel](#_12-sentinel)
    * [13. Sharding](#_13-sharding)
    * [14. Simple Forum System Analysis](#_14-simple-forum-system-analysis)
